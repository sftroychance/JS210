...
// also consider writing a few more test cases to ensure that the input
// validation requirement is properly met.

// the issue in the code is the malformed regex contained in function
// 'isValidName()'.  `\w` matches word characters, which are all
// alphabetical characters and numerical characters and _ (underscore)

// To fix, the regex needs to be changed to accept only letters.

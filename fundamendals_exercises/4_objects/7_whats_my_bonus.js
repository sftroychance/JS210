// The calculateBonus function calculates the bonus for a given salary. It
// makes use of two arguments for determining the bonus: a salary amount and a
// boolean switch. If the boolean is true, the bonus should be half of the
